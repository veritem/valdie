...
section for [Valdie][issues]. When submitting an issue please take the following steps:
...
After you have made and tested your change, commit and push it to your fork. Then, open a Pull Request from your fork to the main [Valide][Valdie] repository on the branch you used in the `Making a Change` section of this document.
...
[Valdie]: https://github.com/Rwanda-Coding-Academy/Valdie
[repl]: http://repl.it
...
[Valdie][Valdie] supports `typescript`.
